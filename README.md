...
Published libraries and providers, 32,665 downloads combined.

| Project | What it does | Downloads |
| --- | --- | --- |
| [rust-yaml](https://crates.io/crates/rust-yaml) | Fast, safe YAML 1.2 library for Rust | 26,498 |
| [terraform-provider-strcase](https://registry.terraform.io/providers/elioseverojunior/strcase) | String case conversion functions for Terraform | 3,897 |
| [terraform-provider-kind](https://registry.terraform.io/providers/elioseverojunior/kind) | Ephemeral Kubernetes-in-Docker clusters for CI and local test harnesses | 898 |
| [terraform-provider-docker](https://registry.terraform.io/providers/elioseverojunior/docker) | Declarative container lifecycle and image resources | 684 |
| [terraform-provider-dnsmasq](https://registry.terraform.io/providers/elioetibr/dnsmasq) | Local DNS record management as infrastructure as code | 453 |
| [terraform-provider-sops](https://registry.terraform.io/providers/elioetibr/sops) | Native decryption of SOPS-managed secrets inside Terraform plans | 235 |
